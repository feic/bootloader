...
#define MACH_TYPE		168	
#define ARCHITECTURE_MAGIC	((1 << 24) | (7 << 16) | MACH_TYPE)
...
#define CLKDVIN_406_136d     0x5  /* 1:4:8 */
#define UART_PCLK_406_136d       50625000    
...
#else
#define UART_PCLK           UART_PCLK_406_136d
#define vMPLLCON_NOW_USER ((MDIV_406_136d << 12) | (PDIV_406_136d << 4) | (SDIV_406_136d))
#define vCLKDIVN_NOW        CLKDVIN_406_136d
#define vREFRESH            vREFRESH_406_136d
#endif
